...
void UHeroGameplayAbility_TargetLock::OnTargetLockTick(float DeltaTime)
{
	if (!CurrentLockedActor ||
		UHopFunctionLibrary::NativeDoesActorHaveTag(CurrentLockedActor, HopGameplayTags::Shared_Status_Dead) ||
		UHopFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), HopGameplayTags::Shared_Status_Dead)
		)
	{
	...
	const bool bShouldOverrideRotation =
		!UHopFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), HopGameplayTags::Player_Status_Rolling)
		&&
		!UHopFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), HopGameplayTags::Player_Status_Blocking);
...
void UHeroGameplayAbility_TargetLock::SwitchTarget(const FGameplayTag& InSwitchDirectionTag)
{
	...
	if (InSwitchDirectionTag == HopGameplayTags::Player_Event_SwitchTarget_Left)
	{
...
void UHeroGameplayAbility_TargetLock::DrawTargetLockWidget()
{
	if (!DrawnTargetLockWidget)
	{
		...
		DrawnTargetLockWidget = CreateWidget<UHopWidgetBase>(GetHeroControllerFromActorInfo(), TargetLockWidgetClass);
